    ...
    <div class="row">
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-info card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="font-weight-bold text-white font-size-sm">Active Clients</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 30-->
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-dark card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="font-weight-bold text-white font-size-sm">Expiring Auths</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 32-->
            ...
            <div class="card card-custom bg-light-success card-stretch gutter-b">
                ...
                <div class="card-body">
                    <span class="svg-icon svg-icon-2x svg-icon-success">
                        <!--begin::Svg Icon | path:/metronic/theme/html/demo10/dist/assets/media/svg/icons/Communication/Mail-opened.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24" />
                    ...
                    <span class="font-weight-bold text-muted font-size-sm">Total Billed</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 25-->
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-danger card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="font-weight-bold text-white font-size-sm">Total Deposit</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 31-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Last Week Billed</h3>
                    </div>
                </div>
                <div class="card-body">
                    <!--begin::Chart-->
        ...
        <div class="col-lg-4">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Current Billing</h3>
                    </div>
                </div>
                <div class="card-body">
                    <!--begin::Chart-->
        ...
        <div class="col-lg-4">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Overall (Current Month)</h3>
                    </div>
                </div>
                <div class="card-body">
                    <!--begin::Chart-->
